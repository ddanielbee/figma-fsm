...
export declare type FigmaNode = FigmaDocument | FigmaCanvas | FigmaFrame | FigmaGroup | Vector | BooleanGroup | Star | Line | Ellipse | RegularPolygon | Rectangle | Text | Slice | Component | Instance;
...
declare type BlendMode = string;
declare type EasingType = string;
